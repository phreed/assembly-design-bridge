...
void protobuf_AssignDesc_XsdTypes_2eproto() {
  protobuf_AddDesc_XsdTypes_2eproto();
  ...
  static const int ID_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ID, uuid_),
  };
  ID_reflection_ =
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_XsdTypes_2eproto);
}
...
void protobuf_AddDesc_XsdTypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ta\"\022\n\002ID\022\014\n\004uuid\030\001 \002(\014", 62);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "XsdTypes.proto", &protobuf_RegisterTypes);
  ID::default_instance_ = new ID();
  ID::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_XsdTypes_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_XsdTypes_2eproto {
  StaticDescriptorInitializer_XsdTypes_2eproto() {
    protobuf_AddDesc_XsdTypes_2eproto();
  }
} static_descriptor_initializer_XsdTypes_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int ID::kUuidFieldNumber;
#endif  // !_MSC_VER
...
const ID& ID::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_XsdTypes_2eproto();
